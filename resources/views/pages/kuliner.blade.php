...
<div class="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight mb-6">
            Citarasa Legendaris <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-indigo-600">Yogyakarta</span>
        </h1>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="group relative bg-white rounded-3xl shadow-sm border border-blue-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            <!-- Image -->
            ...
            <div class="p-6">
                ...
                <div class="flex items-center justify-between border-t border-gray-100 pt-4">
                    ...
                    <a href="{{ route('kuliner.detail', $item['id']) }}" class="w-10 h-10 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all">
