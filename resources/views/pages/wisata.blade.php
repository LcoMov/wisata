...
<div class="relative pt-40 pb-24 lg:pt-60 lg:pb-40 overflow-hidden text-center text-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('wisata') }}" method="GET">
            <div class="bg-white/95 backdrop-blur-md p-3 md:p-2 rounded-2xl md:rounded-full flex flex-col md:flex-row w-full max-w-2xl mx-auto shadow-2xl items-center border border-white/20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="group relative bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="relative h-64 overflow-hidden">
                ...
                <img src="{{ str_starts_with($item['gambar'], 'wisata/') ? asset('storage/'.$item['gambar']) : asset('images/'.$item['gambar']) }}" alt="{{ $item['nama'] }}" 
            ...
            <div class="p-6">
                ...
                <p class="text-gray-500 text-sm mb-6 line-clamp-2">
                    Nikmati pengalaman tak terlupakan di {{ $item['nama'] }}. Pemandangan indah dan suasana yang menenangan menanti Anda.
                </p>
                ...
                <div class="flex items-center justify-between border-t border-gray-100 pt-4">
                    ...
                    <a href="{{ route('wisata.detail', $item['id']) }}" class="w-10 h-10 rounded-full bg-blue-50 text-primary flex items-center justify-center hover:bg-primary hover:text-white transition-all transform hover:rotate-45">
