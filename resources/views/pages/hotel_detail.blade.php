...
<div class="relative h-[60vh] overflow-hidden">
    ...
    <div class="absolute bottom-0 left-0 w-full z-20 p-8 md:p-16 bg-gradient-to-t from-gray-900 to-transparent">
        <div class="max-w-7xl mx-auto">
            <span class="bg-blue-600 text-white text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-4 inline-block">
                Hotel & Penginapan
            </span>
            ...
            <div class="flex items-center text-gray-200 gap-4 text-sm md:text-base">
                <span class="flex items-center"><i class="bi bi-geo-alt-fill text-primary mr-2"></i> {{ $hotel->location }}</span>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="lg:sticky top-32 bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0 w-11 h-11 rounded-xl bg-blue-50/50 border border-blue-100 flex items-center justify-center text-primary shadow-sm">
                            <i class="bi bi-clock text-xl"></i>
                        </div>
                        <div class="flex flex-col">
                            <span class="text-[11px] text-gray-400 font-bold uppercase tracking-wider mb-0.5">Waktu Check-in</span>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex flex-col">
                            <span class="text-[11px] text-gray-400 font-bold uppercase tracking-wider mb-0.5">Lokasi</span>
