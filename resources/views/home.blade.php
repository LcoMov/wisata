...
<div class="relative h-screen min-h-[600px] flex items-center justify-center text-center text-white overflow-hidden">
    ...
    <div class="relative z-10 px-4 w-full max-w-5xl mx-auto mt-16">
        ...
        <p class="text-lg md:text-xl text-gray-200 mb-10 max-w-3xl mx-auto drop-shadow-md font-medium">
            Temukan destinasi tersembunyi, cita rasa lokal yang autentik, dan paket liburan terbaik hanya dalam satu platform.
        </p>

        <!-- Search Bar -->
        <form action="{{ route('wisata') }}" method="GET" class="bg-white/95 backdrop-blur-md p-3 md:p-2 rounded-2xl md:rounded-full flex flex-col md:flex-row w-full max-w-2xl mx-auto shadow-2xl items-center border border-white/20">
            ...
            <button type="submit" class="w-full md:w-auto mt-3 md:mt-0 bg-primary hover:bg-secondary text-white px-8 py-3 rounded-xl md:rounded-full font-bold transition-all transform hover:scale-105 shadow-md">
                Cari
            </button>
        </form>
    </div>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            ...
            <a href="{{ route('wisata') }}" class="text-primary font-bold hover:text-secondary flex items-center gap-2 group transition-colors">
                Lihat Semua 
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 relative">
                <!-- Image -->
                <div class="relative h-64 overflow-hidden">
                    <a href="{{ route('wisata.detail', $item['id']) }}" class="absolute inset-0 z-20"></a>
                    <img src="{{ str_starts_with($item['gambar'], 'wisata/') ? asset('storage/'.$item['gambar']) : asset('images/'.$item['gambar']) }}" 
                         alt="{{ $item['nama'] }}" 
                ...
                <div class="p-6">
                    ...
                    <a href="{{ route('wisata.detail', $item['id']) }}" class="text-primary font-bold hover:text-secondary flex items-center gap-1 group/btn">
                        Lihat Detail
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            ...
            <a href="{{ route('artikel') }}" class="text-primary font-bold hover:text-secondary flex items-center gap-2 group transition-colors">
                Lihat Semua Artikel
                <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
            ...
            <div class="group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                        ...
                        <a href="{{ route('artikel.detail', $artikel->id) }}" class="text-primary font-bold text-sm hover:underline">Baca Selengkapnya</a>
                    </div>
                </div>
            </div>
            @endforeach
