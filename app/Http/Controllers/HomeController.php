...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $wisataPopuler = Wisata::select('*', 'foto as gambar')->take(3)->get()->toArray();
        $wisataHits = Wisata::select('*', 'foto as gambar')->skip(3)->take(3)->get()->toArray();
    ...
    public function wisata(Request $request)
    {
        ...
        $wisata = $query->select('*', 'foto as gambar')->get()->toArray();
    ...
    public function hotel(Request $request)
    {
        ...
        $hotels = $query->select('*', 'location as loc')->get()->toArray();
    ...
    public function kuliner(Request $request)
    {
        ...
        $kuliner = $query->select('*', 'category as type', 'price_range as price', 'description as desc')->get()->toArray();
